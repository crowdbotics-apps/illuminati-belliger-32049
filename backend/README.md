...
## Project Structure
    ...
    ├── illuminati_belliger_32049  # Django project configurations
...
1. Clone this repo and `cd illuminati_belliger_32049`
...
2. Clone this repo and `cd illuminati_belliger_32049`
